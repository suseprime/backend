...
exports.callback = function (params, user) {
  ...
  data.sockets[pendingChat.from].sendMessage({'type':'chat-established', 'chat-id': chatId, 'target-username': user.username});
  user.sendMessage({'type': 'chat-request-accepted-successed', 'chat-id': chatId, 'request-id': params['request-id']})
};
